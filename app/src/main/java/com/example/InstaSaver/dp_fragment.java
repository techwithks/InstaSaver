...
public class dp_fragment extends Fragment {
    ...
    private void processdata() {
        ...
        StringRequest request=new StringRequest(URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                dpurl = mainURL.getGraphql().getShortcode_media().getDisplay_url();
                uri2 = Uri.parse(dpurl);
                Glide.with(getContext()).load(uri2).into(mparticulardp);
